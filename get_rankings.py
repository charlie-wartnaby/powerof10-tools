...
def output_records(output_file, first_year, last_year, club_id, do_po10, do_runbritain,
    ...
    header_part.append(f'<p>Outputting maximum {max_records_all} places overall per event and {max_records_age_group} per age group.</p>\n')
    header_part.append(f'<p>Outputting maximum {max_wavas_all} places for all time age graded and {max_wavas_year} per year, per event.</p>\n')
