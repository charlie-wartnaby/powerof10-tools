...
# Age categories for juniors were changed by UK Athletics in 2026 as currently
# explained here: https://www.englandathletics.org/about-us/age-group-changes
# As we have many historical club records using the old categories, they are maintained
...
"""
    ...
    sources_part = ['<h2><a name="sources" />Details and Sources for Club Records</h2>\n',
...
def output_record_table(bulk_part, record_list, type):
    ...
    for idx, perf_list in enumerate(record_list):
        for perf_idx, perf in enumerate(perf_list): # May be ties with same score or different sources
            ...
            if False: # Until we have new powerof10 links... 
