...
python get_rankings.py --clubid 238 --cache cnc_cache.pkl --rebuild-final-year y --rebuild-wava y --ea-pb-award-file EA_PB_Awards_tables.xlsx 2022_CnC_records.xlsx 2021_CnC_records.xlsx 2009_CnC_records.xlsx CnC_known_historical.xlsx